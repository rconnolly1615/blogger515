...
class BlogPostsControllerTest < ActionController::TestCase
  ...
  test "should create blog_post" do
    assert_difference('BlogPost.count') do
      post :create, blog_post: { blog_id: @blog_post.blog_id, num_comments: @blog_post.num_comments, subject: @blog_post.subject, text: @blog_post.text }
    end
  ...
  test "should update blog_post" do
    patch :update, id: @blog_post, blog_post: { blog_id: @blog_post.blog_id, num_comments: @blog_post.num_comments, subject: @blog_post.subject, text: @blog_post.text }
    assert_redirected_to blog_post_path(assigns(:blog_post))
  end
